...
def train(train_loader, model, optimizer, epoch, test_path):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            lateral_map_4,lateral_map_5,lateral_map_6 = model(images)
            ...
            loss = 0.1*loss4 + 0.3*loss5 + 0.6*loss6    # TODO: try different weights for loss
            #loss = loss5
            # ---- backward ----
            loss.backward()
